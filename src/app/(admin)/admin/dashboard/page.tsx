              ...
              <div className="mt-8">
                <div className="flex justify-end mb-4">
                  <button 
                    ...
                    className="flex items-center px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-transform"
                  >
